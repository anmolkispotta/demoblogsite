	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
                    '{{WRAPPER}} .coneblog-posts-list.layout-1 .item-thumb' => 'min-width: {{SIZE}}{{UNIT}};',
				],
                'conditions' => [
					'relation' => 'and',
					'terms' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .coneblog-posts-list .list-item .grid-post-term span.term-icon' => 'background-color: {{VALUE}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .coneblog-posts-list .list-item .grid-post-term span.term-icon' => 'color: {{VALUE}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .coneblog-posts-list .list-item .grid-post-term span.term-name' => 'background-color: {{VALUE}}',
				],
				'default' => '#f6ce2b',
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .coneblog-posts-list .list-item .grid-post-term span.term-name' => 'color: {{VALUE}}',
				],
				'default' => '#000000',
			]
		);
                        ...
                        <div class="item-meta">
                            ...
                            <p class="post-desc">
                                ...
                                if ( 'yes' === $settings['show_excerpt'] ) {
                                    echo Helper::coneblog_list_excerpt(15);
                                }
