	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#333333',
                'selectors' => [
                    '{{WRAPPER}} .coneblog-posts-carousel.layout-2 .coneblog-carousel .item .item-meta h3 a' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#f6ce2b',
                'selectors' => [
                    '{{WRAPPER}} .coneblog-posts-carousel .coneblog-carousel .item .item-meta h3 a:hover' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
					'{{WRAPPER}} .coneblog-posts-carousel .coneblog-carousel .item .item-meta h3' => 'text-align: {{VALUE}};',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' =>
					'{{WRAPPER}} .coneblog-posts-carousel .coneblog-carousel .item .item-meta h3 a',
            ]
        );
		$this->add_group_control(
            Group_Control_Typography::get_type(),
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .coneblog-posts-carousel .coneblog-carousel .item .item-meta h3 a',
			]
		);
        $this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .coneblog-carousel .item .grid-post-term span.term-icon' => 'background-color: {{VALUE}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .coneblog-carousel .item .grid-post-term span.term-icon' => 'color: {{VALUE}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .coneblog-carousel .item .grid-post-term span.term-name' => 'background-color: {{VALUE}}',
				],
				'default' => '#f6ce2b',
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .coneblog-carousel .item .grid-post-term span.term-name' => 'color: {{VALUE}}',
				],
				'default' => '#000000',
			]
		);
	...
	protected function render() {
		...
		?>
            <div class="coneblog-posts-carousel-container">
                <div class="coneblog-posts-carousel layout-<?php echo $layout ?>">
                    <div class="coneblog-carousel owl-carousel">
                        ...
                        if ( '1' === $settings['layout'] ) {
                            ?>
								<div class="item" style="background-image: url('<?php echo $thumb_uri ?>') ">
									<?php
